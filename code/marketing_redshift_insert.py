...
if __name__ == '__main__':
    ...
    try:
        body = f.read()
        print("Your key: ", str(sys.argv[1]))
        data_to_redshift(breakdown = translate_break[str(sys.argv[1])], 
                            table_name = stages_table[str(sys.argv[1])], 
                            list_of_intenger = integer_dict[str(sys.argv[1])], 
                            list_of_floats64 =float_dict[str(sys.argv[1])], 
                            list_of_strings = string_dict[str(sys.argv[1])]
                            )
